module.exports = {
  ...
  //
  // 2026-09-26 上调（补 `tests/virtual/water-virtual-doc.test.ts` 之后实测
  // 语句 91.71% / 分支 75.33% / 函数 91.71% / 行 92.19%，此前是 84.8 / 72.48 / 87.89 / 85.45）：
  // 语句 / 函数 / 行按同样的"留 ~3pp 余量"口径抬到 89；**分支留在 74**——
  // 按同口径该抬到 ~73，那是往下调（棘轮不许），所以维持原值。
  coverageThreshold: {
    global: {
      statements: 89,
      branches: 74,
